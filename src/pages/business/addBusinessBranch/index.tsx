...
const AddBusinessBranch: FunctionComponent = () => {
  ...
  const step2WasInitiatedRef = useRef<boolean>(false)
  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center flex-1 h-full bg-[#EFF0F1] py-1.5">
      ...
      {step === 2 && <Step2 step1Data={step1Data} setStep={(step: number)=>setStep(step)} step2WasInitiatedRef={step2WasInitiatedRef} />}
    </div>
  )
}
